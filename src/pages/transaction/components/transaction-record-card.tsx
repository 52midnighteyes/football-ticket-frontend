...
export function TransactionRecordCard({
  ...
  const backgroundImageUrl = transaction.eventSummary.bannerUrl
    ? optimizeCloudinaryImage(transaction.eventSummary.bannerUrl, {
        width: 1600,
        height: 900,
        crop: "fill",
      })
  ...
  return (
    <Card
      className={`relative gap-0 overflow-hidden border-border/80 bg-card py-0 shadow-sm transition ${
    ...
    >
      {backgroundImageUrl ? (
        <div className="pointer-events-none absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.92)_0%,rgba(255,255,255,0.86)_38%,rgba(244,246,241,0.94)_100%)]" />
        </div>
      ) : null}
      ...
      <div className="relative flex flex-col">
        ...
        <CardContent className="grid gap-5 px-5 py-5 lg:grid-cols-[minmax(0,1fr)_260px]">
          ...
          <div className="space-y-4">
            <div className="space-y-3 rounded-2xl border border-primary/12 bg-linear-to-br from-primary/5 via-card/80 to-accent/8 p-4 backdrop-blur-sm">
            ...
            {canUploadPaymentProof ? (
              <div className="space-y-4 rounded-2xl border border-border/70 bg-background/65 p-4 backdrop-blur-sm">
